...
import es.lab.cardoc.domain.Document;
import es.lab.cardoc.domain.Car;
import es.lab.cardoc.repository.DocumentRepository;
import es.lab.cardoc.web.rest.errors.ExceptionTranslator;
...
import static es.lab.cardoc.web.rest.TestUtil.createFormattingConversionService;
