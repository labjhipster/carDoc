...
import es.lab.cardoc.config.audit.AuditEventConverter;
import es.lab.cardoc.domain.PersistentAuditEvent;
import es.lab.cardoc.repository.PersistenceAuditEventRepository;
import es.lab.cardoc.security.AuthoritiesConstants;

import es.lab.cardoc.service.AuditEventService;
